...
import './NewListPro.css';

import MoveButton from './MoveButton'; // Import the MoveButton component
  ...
  return (
    <div>
      <div className="game-area">
        <MoveButton
          moveType="ROCK"
          imageSrc="/images/rock-emoji.png"
          onClick={playGame}
        />
        <MoveButton
          moveType="PAPER"
          imageSrc="/images/paper-emoji.png"
          onClick={playGame}
        />
        <MoveButton
          moveType="SCISSORS"
          imageSrc="/images/scissors-emoji.png"
          onClick={playGame}
        />
        <MoveButton
          moveType="REFRESH"
          imageSrc="/images/refresh-emoji.png"
          onClick={clearScore}
        />
